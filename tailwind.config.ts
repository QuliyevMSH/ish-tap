	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-card': 'linear-gradient(180deg, var(--card) 0%, var(--card-foreground-light) 100%)',
				'gradient-primary': 'linear-gradient(90deg, hsla(277, 75%, 84%, 1) 0%, hsla(297, 50%, 51%, 1) 100%)',
				'gradient-secondary': 'linear-gradient(90deg, hsla(24, 100%, 83%, 1) 0%, hsla(341, 91%, 68%, 1) 100%)',
